  ...
  return (
    <main className="min-h-screen bg-[#141414]">
        ...
        <div className="relative z-10 h-full flex flex-col justify-center px-6 md:px-16 max-w-3xl space-y-6">
          ...
          >
            ...
            <p className="text-gray-300 text-lg mt-4 leading-relaxed">
              Adrenaline-pumping stunts, high-stakes chases, and epic battles.
              Explore the best of Action cinema on TiveesMedia.
            </p>
      ...
      <div className="pb-20 -mt-20 relative z-20">
        <MovieRow title="Trending Action" movies={actionMovies} />

        <div className="mt-8">
          <MovieRow title="Martial Arts Specials" movies={[...actionMovies].reverse()} />
        </div>
