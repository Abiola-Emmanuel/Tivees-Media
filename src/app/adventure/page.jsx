    ...
    <main className="min-h-screen bg-[#141414]">
      ...
      <section className="relative h-screen w-full overflow-hidden">
        <div
          ...
          style={{ backgroundImage: `url('/adventure-bg.jpg')` }}
        />
        ...
        <div className="relative z-10 h-full flex flex-col justify-center px-6 md:px-16 max-w-3xl space-y-6">
          ...
          >
            ...
            <p className="text-gray-300 text-lg mt-4 leading-relaxed">
              Epic quests, daring expeditions, and thrilling journeys across exotic worlds.
              Explore the best of Adventure cinema on TiveesMedia.
            </p>
      ...
      <div className="pb-20 -mt-20 relative z-20">
        <MovieRow title="Trending Adventures" movies={adventureMovies} />

        <div className="mt-8">
          <MovieRow title="Epic Expeditions" movies={[...adventureMovies].reverse()} />
        </div>
        ...
        <div className="mt-8 px-6 md:px-16">
          <div className="bg-[#0f0f0f] border border-white/10 rounded-2xl p-8 flex flex-col md:flex-row justify-between items-center gap-6">
            <div>
              ...
              <p className="text-gray-400">Request an adventure movie and we'll add it to the library.</p>
            </div>
