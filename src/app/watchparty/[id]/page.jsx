      ...
      {loading ? (
        ...
        >
          ...
          <div className="relative w-full h-screen overflow-hidden mb-20">
            ...
            <button
              onClick={() => router.back()}
              className="absolute top-20 left-6 z-30 cursor-pointer transition text-white"
            >
              ← Back
            </button>
            ...
            >
              <div className="container mx-auto">
                <div className="max-w-2xl  mx-auto rounded-2xl border border-white/10  backdrop-blur-xl p-4 md:p-6 shadow-2xl">
